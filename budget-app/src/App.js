    ...
    <>
      <Container className="my-4">
        <Stack direction="horizontal" gap="2" className="mb-4">
          <h1 className="me-auto">Valentine Budgets</h1>
        ...
        <div style={{
          ...
          <BudgetCard name="Marketing" amount={700} max={1000} gray></BudgetCard>
          <BudgetCard name="RnD" amount={1200} max={1000} gray></BudgetCard> */}
          {budgets.map(budget => {
